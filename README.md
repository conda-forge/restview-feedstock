...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/restview-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10617&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/restview-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `restview` can be installed with:

```
conda install restview
```

It is possible to list all of the versions of `restview` available on your platform with:
